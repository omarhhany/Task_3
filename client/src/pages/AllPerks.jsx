...
export default function AllPerks() {
  ...
  // Initial load (fetch all perks on mount)
  useEffect(() => {
    loadAllPerks()
  }, [])

  // Auto-reload when search or filter changes (debounced)
  useEffect(() => {
  ...
  // Extract unique merchant names from fetched perks
  useEffect(() => {
  ...
  function handleSearch(e) {
    e.preventDefault()
    loadAllPerks() // Manual trigger (immediate)
  }
